<?php 
    ...
    if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
        ...
        if( $num == 1 ) {
            ...
            $_SESSION['application_number'] = $app_no;
...
<div class="container" style="border-radius:10px; height:300px; margin-top:20px;">
    ...
    <div class="row" style="border-width: 2px; border-style: solid; border-radius: 10px; box-shadow: 0px 1px 30px 1px #284d7a; background-color:#F7FFFF;">
         ...
         <div class="col-md-6"style=" height:403px; border-radius: 10px 0px 0px 10px;"><img width=300; src="logo-iitp.png" style="margin-top: 5%; margin-left: 20%; height: 75%">
           ...
           <form  action="login.php" role="form" method="post">
            <input type="hidden" name="ci_csrf_token" value="" />
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-9">
                      <a href="forget_pass.php"><button type="button" class="cancelbtn pull-right">Reset Password</button></a>
                    </div>
                  </div>
